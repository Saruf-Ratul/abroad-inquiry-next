        ...
        <Box margin="auto" py={5}>
          ...
          <Typography textAlign="justify" marginBottom={2}>
            ...
            <ul style={{ listStylePosition: "inside" }}>
              ...
              <li>
                <strong>Application</strong> refers to Abroad Inquiry, the
                software program provided by the Company.
              </li>
              <li>
                <strong>Company</strong> (referred to as either the Company,
                 We, Us or Our in this Agreement) refers to Abroad Inquiry,
                Block: C, House No: 47, Road No: 6, 5th floor, Niketon, Gulshan
          ...
          <Typography textAlign="justify" marginBottom={2}>
            ...
            is already associated with Your Third-Party Social Media Services
            ...
            the Company through Your Third-Party Social Media Services account.
          ...
          <Typography textAlign="justify" marginBottom={2}>
            ...
            Application, We may collect, with Your prior permission: <br />
            <ul style={{ listStylePosition: "inside" }}>
              <li>
                Pictures and other information from your Devices camera and
                photo library
              </li>
            </ul>
            ...
            to the Companys servers and/or a Service Providers server or it
          ...
          <Typography textAlign="justify" marginBottom={2}>
            ...
            <ul style={{ listStylePosition: "inside" }}>
              <br />
              <li>
                <strong>Necessary / Essential Cookies</strong> <br /> Type:
                Session Cookies
                <br />
                Administered by: Us
                <br />
              ...
              <li>
                ...
                Administered by: Us <br /> Purpose: These Cookies identify if
          ...
          <Typography textAlign="justify" marginBottom={2}>
            ...
            We may share Your personal information in the following situations:s
            <ul style={{ listStylePosition: "inside" }}>
              <li>
