...
export const fetchBlogPosts = createAsyncThunk("blogPosts/fetchBlogPosts", async (page) => {
    const blogs = getAllblogPosts(page);
    return blogs;
})

export const fetchBlogPostDetails = createAsyncThunk("blogPosts/fetchBlogPostDetails", async (id) => {
